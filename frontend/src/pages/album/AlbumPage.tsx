...
import { formateDuration } from "@/lib/format";
        ...
        <div className="relative min-h-full">
          ...
          <div className=" relative z-10">
            ...
            <div className=" bg-black/20 backdrop-blur-sm">
              {/* table header */}
              <div
                className=" grid grid-cols-[16px_4fr_2fr_1fr] gap-4 
            px-10 py-2 text-sm text-zinc-400 border-b border-white/5"
              >
                <div>#</div>
                <div>Title</div>
                ...
                <div className=" space-y-2 py-4">
                  {currentAlbum?.songs.map((song, index) => {
                    ...
                    return (
                      ...
                      text-sm text-zinc-400 hover:bg-white/5 rounded-md group cursor-pointer`}
                      >
